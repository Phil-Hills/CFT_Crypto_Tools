...
use crate::common::{
  alloc_c_string, Amount, byte_from_hex_unsafe, ByteData,
  CfdError, collect_cstring_and_free, collect_multi_cstring_and_free, ErrorHandle, hex_from_bytes, Network, ReverseContainer,
};
...
use self::cfd_sys::{
  ...
  CfdGetTxInfoByHandle, CfdGetTxInIndex, CfdGetTxInIndexByHandle,
  CfdGetTxInWitnessByHandle, CfdGetTxInWitnessCountByHandle, CfdGetTxOutByHandle,
