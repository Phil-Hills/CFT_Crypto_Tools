...
use crate::common::{
  alloc_c_string, byte_from_hex, byte_from_hex_unsafe, ByteData,
  CfdError, collect_cstring_and_free, collect_multi_cstring_and_free, ErrorHandle, hex_from_bytes, Network,
};
use crate::key::{Privkey, Pubkey};

use self::cfd_sys::{
  CfdConvertEntropyToMnemonic, CfdConvertMnemonicToSeed, CfdCreateExtkey, CfdCreateExtkeyFromParent,
  CfdCreateExtkeyFromParentPath, CfdCreateExtkeyFromSeed, CfdCreateExtPubkey,
