...
use crate::common::{
  alloc_c_string, Amount, byte_from_hex, byte_from_hex_unsafe,
  ByteData, CfdError, collect_cstring_and_free, collect_multi_cstring_and_free, ErrorHandle, hex_from_bytes,
  Network, request_json, ReverseContainer,
};
use crate::transaction::{
  FeeData, FeeOption, FundOptionValue, FundTargetOption, FundTransactionData, HashTypeData,
  OutPoint, ScriptWitness, SEQUENCE_LOCK_TIME_DISABLE, set_fund_tx_option, SigHashOption, TransactionOperation, TxData,
  TxDataHandle, Txid, TxInData, UtxoData,
};

use self::cfd_sys::{
  BLIND_OPT_COLLECT_BLINDER, BLIND_OPT_EXPONENT, BLIND_OPT_MINIMUM_BITS, BLIND_OPT_MINIMUM_RANGE_VALUE,
  CfdAddBlindTxInData, CfdAddBlindTxOutByAddress,
  CfdAddBlindTxOutData, CfdAddCoinSelectionAmount,
  CfdAddCoinSelectionUtxoTemplate, CfdAddConfidentialTxOutput, CfdAddConfidentialTxSignWithPrivkeySimple,
  CfdAddTargetAmountForFundRawTx, CfdAddTransactionInput, CfdAddTxInTemplateForEstimateFee,
  CfdAddTxInTemplateForFundRawTx, CfdAddUtxoTemplateForFundRawTx, CfdCreateConfidentialSighash, CfdFinalizeBlindTx,
  CfdFinalizeCoinSelection, CfdFinalizeEstimateFee, CfdFinalizeFundRawTx, CfdFinalizeTransaction,
  CfdFreeBlindHandle, CfdFreeCoinSelectionHandle, CfdFreeEstimateFeeHandle,
  CfdFreeFundRawTxHandle, CfdFreeTransactionHandle, CfdGetAppendTxOutFundRawTx,
  CfdGetAssetCommitment, CfdGetBlindTxBlindData, CfdGetConfidentialTxInfoByHandle,
  CfdGetConfidentialTxOutSimpleByHandle, CfdGetConfidentialValueHex, CfdGetDefaultBlindingKey,
  CfdGetIssuanceBlindingKey, CfdGetSelectedCoinIndex, CfdGetTxInByHandle, CfdGetTxInIndexByHandle,
  CfdGetTxInIssuanceInfoByHandle, CfdGetTxOutIndex, CfdGetValueCommitment,
  CfdInitializeBlindTx, CfdInitializeCoinSelection, CfdInitializeEstimateFee,
  CfdInitializeFundRawTx, CfdInitializeTransaction, CfdSetBlindTxOption, CfdSetOptionCoinSelection,
  CfdSetOptionEstimateFee, CfdSetRawReissueAsset, CfdUnblindIssuance, CfdUnblindTxOut,
  CfdUpdateTxOutAmount, COIN_OPT_BLIND_EXPONENT, COIN_OPT_BLIND_MINIMUM_BITS,
